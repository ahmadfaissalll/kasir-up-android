...
public class RequestHandler {
    public String sendPostRequest(String requestURL, HashMap<String, String> postDataParams) {
        ...
        try {
            ...
            System.out.println("error sendPostRequest Method on request handler: " + e.toString());
        }
    ...
    public String sendGetRequest(String requestURL) {
        ...
        try {
            ...
            System.out.println("error sendGetRequest Method on request handler: " + e.toString());
        }
